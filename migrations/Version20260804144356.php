 ...
 */
final class Version20260804144356 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_VILLE_NOM_CP ON ville (nom, code_postal)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_VILLE_NOM_CP ON ville');
    }
}
